  ...
  return (
    <div className="w-full flex flex-col items-center justify-center pt-3 pb-1 mt-auto border-t border-cyan-500/30 text-slate-300 relative z-10">
      ...
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <div className="flex items-center gap-2.5 font-montserrat font-black text-3xl sm:text-4xl tracking-[0.25em] text-white uppercase leading-none drop-shadow-md">
          <span className="text-[#FF6500] font-mono text-3xl sm:text-4xl font-extrabold">/</span>
          <span>ALT LİGLER</span>
          <span className="text-[#FF6500] font-mono text-3xl sm:text-4xl font-extrabold">/</span>
        </div>

        {/* Call to action subtitle */}
        <span className="text-[10px] sm:text-xs font-mono text-[#00AFAF] uppercase tracking-[0.25em] font-extrabold mt-2">
          BİZİ SOSYAL MEDYADA TAKİP ET
        </span>
      </div>

      {/* Social Handles Bar (5 Platforms - Improved Spacing) */}
      <div className="w-full flex items-center justify-center gap-3.5 sm:gap-5 mt-2 pt-1.5 pb-0.5 border-t border-cyan-500/20 text-[10px] sm:text-xs font-mono font-bold text-slate-200">
        {/* Instagram */}
